...
\begin{rSection}{Relevant Experience}
    ...
    \begin{rSubsection}{Senior Software Engineer}{\em February 2024 \textbf{--} June 2026}{Raise Robotics}{}
        \item Wrote and own the majority of the robot's Python backend, including motion planning, hardware interfaces, and the ROS2 node graph
        ...
        \item Wrote a CLI tool for linting/formatting and automated UI testing with Jest, integrated into a GitHub Actions CI/CD pipeline that builds, tests, and publishes the Docker image (AWS registry) and Electron app (AWS distribution)
    ...
    \begin{rSubsection}{Robotics Software Engineer}{\em May 2022 \textbf{--} February 2024}{Raise Robotics}{}
        \item Joined as Raise Robotics' first full-time engineer; wrote the majority of the codebase's backend, including ROS1 motion planning and control software, primarily in Python with performance-critical components in C++, for a 6-DOF robotic arm
...
\begin{rSection}{Technical Skills}
    ...
    \begin{tabular}{ @{} >{\bfseries}l @{\hspace{2ex}} l }
        Languages \         & \footnotesize Python, TypeScript, JavaScript, C++, C\#, Java                 \\
